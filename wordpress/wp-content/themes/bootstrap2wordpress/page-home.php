    		...
    		<div class="container clearfix">
    			<div class="row">
    				...
    				<div class="col-sm-7 hero-text">
    					<h1>I Love Cats SuperFriends</h1>
    					<p class="lead">We are the best people in the world because we love cats. This is our website where other superfriends get together and discuss things.</p>
	...
	<section id="boost-income">
		<div class="container">
			...
			<div class="section-header">
				<img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-cat.jpg" alt="cat icon">
				<h2>How You Can Make Money With Cats</h2>
			</div>
